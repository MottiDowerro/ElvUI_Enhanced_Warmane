...
----------------------------------------------------------------------------------------
-- Quest & Achievement Colorization
----------------------------------------------------------------------------------------
function WF:UpdateWatchFrame()
	...
	for _, link in ipairs(WATCHFRAME_LINKBUTTONS or {}) do
		...
		------------------------------------------------------------
		-- ACHIEVEMENTS (Dynamic via Blizzard API)
		------------------------------------------------------------
			...
			for i = startLine, lastLine do
				...
				if line and line.text then
					...
					if i == startLine then
						...
						-- If no match found, try parsing numbers directly
...
----------------------------------------------------------------------------------------
-- Restore colors after hover leave
----------------------------------------------------------------------------------------
