...
L["Holding Alt key while buying something from vendor will now buy an entire stack."] = "Держи Alt, покупая что-то у продавца, чтобы купить целую стопку."
...
L["Undress"] = "Раздеть"
L["Clear Target"] = "Сброс цели"
L["Clear Target Keybind"] = "Клавиша для сброса цели"
L["Clear your current target."] = "Сбрасывает вашу текущую цель."
...
L["BlizzUI Improvements"] = "Улучшения интерфейса Blizzard"